...
do
  ...
  # Execute
  aws logs create-export-task --log-group-name $LAMBDA$i --from ${startTime} --to ${endTime} --destination "ao.cloudwatch" --destination-prefix $FILE$PREFIX$i
  sleep 2s
done